...
class DailyOperation:
    ...
    # The vehicle's name as the fleet catalog spells it. Optional so that
    # operations recorded before the fleet was identified still construct; a
    # model trained on them simply learns nothing here.
