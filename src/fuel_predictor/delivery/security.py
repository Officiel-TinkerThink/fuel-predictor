...
ROUTE_CAPABILITIES: tuple[tuple[str, str, Capability], ...] = (
    ...
    ("POST", "/operasi-harian/*/batalkan", Capability.CREATE_PREDICTION),
    ...
    ("GET", "/impor-data-historis/hasil/*", Capability.MANAGE_MODELS),
    ...
    ("GET", "/prediksi-operasi-massal/hasil/*", Capability.IMPORT_OPERATIONS),
    ...
    ("GET", "/bahan-bakar-aktual-massal/hasil/*", Capability.RECORD_ACTUAL_FUEL),
    ...
    ("POST", "/integrasi-agen/grant/*/nama", Capability.MANAGE_USERS),
    ("POST", "/integrasi-agen/grant/*/hapus", Capability.MANAGE_USERS),
    ("GET", "/agen-saya", Capability.MANAGE_OWN_AGENTS),
    ("POST", "/agen-saya/*/cabut", Capability.MANAGE_OWN_AGENTS),
    ("POST", "/agen-saya/*/nama", Capability.MANAGE_OWN_AGENTS),
    ...
    ("GET", "/akun", Capability.MANAGE_OWN_ACCOUNT),
    ("POST", "/akun", Capability.MANAGE_OWN_ACCOUNT),
